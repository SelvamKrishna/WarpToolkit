...
void write_to_console(level lvl, std::string_view pre, std::string_view msg) {
  ...
  os.write("\033[", sizeof("\033[") - 1);

  switch (lvl) {
    case level::INFO:  os.write("32m[INFO]", sizeof("32m[INFO]") - 1); break;   // Green
    case level::DEBUG: os.write("36m[DEBUG]", sizeof("36m[DEBUG]") - 1); break; // Cyan
    case level::WARN:  os.write("33m[WARN]", sizeof("33m[WARN]") - 1); break;   // Yellow
    case level::ERROR: os.write("31m[ERROR]", sizeof("31m[ERROR]") - 1); break; // Red
  }

  os.write("\033[0m : ", sizeof("\033[0m : ") - 1);
